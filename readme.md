...
용접 공정에서 용접기는 설비의 핵심이다. 용접기를 비롯한 설비 고장 발생 시 생산 라인 전체의 중단으로 이어져 큰 손실이 발생한다. 그러나 대부분의 현장에서는 장비가 작업자에 의해 수작업으로 모니터링되고 있어 즉각적인 변화에 대응이 힘들고 드물지 않게 고장이 발생하는 상황이다.
